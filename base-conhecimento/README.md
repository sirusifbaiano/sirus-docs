...
## 📏 [Padrões de Desenvolvimento](../padroes-dev/readme.md)
- [Padrões de Commits](../padroes-dev/padroes-commit.md) – **INICIANTE, INTERMEDIÁRIO**  
  ➤ Convenção para mensagens de commit: padronização para facilitar leitura do histórico e automação (como changelogs e versionamento semântico).

- [Padrões de Codificação](../padroes-dev/codificacao/readme.md) – **INTERMEDIÁRIO**  
  ➤ Boas práticas de escrita de código: estilo, organização, nomenclatura e legibilidade nos projetos.

- [Padrões de Modais](../padroes-dev/modais/readme.md) – **INTERMEDIÁRIO**  
  ➤ Guia para criação e reutilização de componentes de modal (janelas modais) com consistência visual e comportamental.


> 📌 **Objetivo:** manter consistência no código, facilitar a colaboração em equipe e garantir legibilidade e manutenção a longo prazo.
...
### Acessibilidade
- [wcag](https://www.w3c.br/traducoes/wcag/wcag22-pt-BR/)
